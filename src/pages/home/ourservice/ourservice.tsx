      ...
      <Row className="home-ourservice-row">
        <Col md={4}>
          <div className="home-ourservice-item">
            <img src="./assets/svg/svgexport-1.svg" width='100px' height='100px' />
        ...
        <Col md={4}>
          <div className="home-ourservice-item">
            <img src="./assets/svg/svgexport-2.svg" width='100px' height='100px' />
        ...
        <Col md={4}>
          <div className="home-ourservice-item">
            <img src="./assets/svg/svgexport-3.svg" width='100px' height='100px' />
